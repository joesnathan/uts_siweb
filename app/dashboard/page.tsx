  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-700">
      ...
      <div className="flex justify-between items-start mb-4">
        <div>
          <h1 className="text-4xl font-black tracking-tight text-[#0a2a66]">
            Welcome, Jonathan
          </h1>
          <p className="text-gray-400 font-bold uppercase tracking-widest text-xs mt-1">Role: Operator</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/50">
          ...
          <div className="h-48 w-full bg-blue-50/30 rounded-2xl border border-dashed border-blue-200 flex items-center justify-center relative overflow-hidden">
             ...
             <p className="text-blue-400 font-black text-xs uppercase z-10">Chart Visualization</p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm">
           ...
           <div className="grid grid-cols-2 gap-4">
              <div className="border-r border-gray-100 pr-4">
                 <p className="text-[10px] font-black text-gray-400 uppercase mb-1">Total Cargo Recived</p>
      ...
      <div className="bg-white rounded-[2rem] border border-gray-100 shadow-xl overflow-hidden">
        <div className="p-6 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
          ...
          <button className="bg-[#0a2a66] text-white px-4 py-1.5 rounded-lg text-[10px] font-black uppercase shadow-lg">⬇ Export</button>
        </div>
