...
async function run() {
  try {
    console.log("RUNNING DATABASE SEED AND TABLE MIGRATION...");
    ...
    await sql.begin(async (tx) => {
      ...
      console.log("Creating cargo_tracking table...");
      await tx`
      ...
      console.log("Inserting cargo dummy rows...");
      ...
      console.log("Inserting user dummy data...");
      await tx`
      ...
      console.log("Inserting tickets dummy data...");
      await tx`
